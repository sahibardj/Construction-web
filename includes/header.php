...
<body>
  ...
  <nav class="navbar navbar-expand-lg nv" style="bac">
    <a class="navbar-brand px-3" href="#"><img src="logo.png"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width: 100%;  ">
      <ul class="navbar-nav " style="padding-left:24%;">
     ...
     Projects
          ...
          <div class="dropdown-menu dd"  aria-labelledby="navbarDropdown">
            <a class="dropdown-item dd" href="township.php"   >  Township</a>
            <a class="dropdown-item dd" href="commercial.php"   >Commercial</a>
       
            <a class="dropdown-item dd" href="residential.php"   >Residential</a>
          </div>
        </li>
        <li class="nav-item dropdown dd " >
   ...
   About Us
          ...
          <div class="dropdown-menu dd"  aria-labelledby="navbarDropdown">
            <a class="dropdown-item dd" href="profile.php"   > Profile</a>
            <a class="dropdown-item dd" href="mission.php"   >Mission/Visson</a>
       
            <a class="dropdown-item dd" href="quality.php"   >Quality</a>
          </div>
        </li>
 ...
 Media
          ...
          <div class="dropdown-menu dd"  aria-labelledby="navbarDropdown">
            <a class="dropdown-item dd" href="profile.php"   > Press Release</a>
